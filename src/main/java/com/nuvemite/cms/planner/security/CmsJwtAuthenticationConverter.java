...
public class CmsJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        Collection<GrantedAuthority> authorities = List.of(new SimpleGrantedAuthority("ROLE_" + principal.platformRole()));
        return new CmsAuthenticationToken(jwt, principal, authorities);
    }
}
